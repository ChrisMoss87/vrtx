...
/**
 * Data Transfer Object for quote line item responses.
 */
final readonly class QuoteLineItemResponseDTO implements JsonSerializable
{
    ...
    public static function fromEntity(QuoteLineItem $lineItem): self
    {
        return new self(
            id: $lineItem->getId(),
