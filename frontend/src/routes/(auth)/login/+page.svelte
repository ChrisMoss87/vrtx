            ...
            <div class="w-full max-w-xs">
                <form class="flex flex-col gap-6" onsubmit={handleSubmit}>
                    ...
                    <FieldGroup>
                        ...
                        <TextField label="Email" name="email" bind:value={email} type="email" placeholder="example@vrtx.com" required />
                        <TextField label="Password" name="password" bind:value={password} type="password" placeholder="*******" required />
